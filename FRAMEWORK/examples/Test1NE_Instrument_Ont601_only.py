...
class Test(TestCase):
    ...
    def test_body(self):
        ...
        #callResult = ONT6xx.get_set_measurement_time("P1", 1)
        #print("ONT6xx.get_set_measurement_time result: [{}]".format(callResult))
        #callResult = ONT6xx.start_measurement("P1")
        #print("ONT6xx.start_measurement: [{}]".format(callResult))





        print("\n\n\n\n\nTESTING ONT6xx SECTION START *************************************")
        #input("press enter to continue...\n")




        callResult = ONT6xx.get_set_rx_bit_rate("P1")
        print("ONT6xx.get_set_rx_bit_rate result: [{}]".format(callResult))
        #input("press enter to continue...\n")



        callResult = ONT6xx.get_set_rx_bit_rate("P1","STM1")
        print("ONT6xx.get_set_rx_bit_rate result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_clock_reference_source("P1")
        print("ONT6xx.get_set_clock_reference_source result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_clock_reference_source("P1","RX")
        print("ONT6xx.get_set_clock_reference_source result: [{}]".format(callResult))
        #input("\n\npress enter to continue...\n")


        callResult = ONT6xx.retrieve_optical_alarms("P1")
        print("ONT6xx.retrieve_optical_alarms result: [{}]".format(callResult))
        #input("\n\npress enter to continue...\n")
 

        callResult = ONT6xx.retrieve_sdh_alarms("P1")
        print("ONT6xx.retrieve_optical_alarms result: [{}]".format(callResult))
        #input("\n\npress enter to continue...\n")
        ...
        #input("\n\npress enter to continue...\n")
        #usercommand=input("\n\nInsert RAW command for check\n")
        #callResult = ONT6xx.cli_user_debug_command(usercommand,"P1")
        #print("ONT6xx.cli_user_debug_command result: [{}]".format(callResult))
        callResult = ONT6xx.retrieve_ho_alarms("P1")
        print("ONT6xx.retrieve_ho_alarms result: [{}]".format(callResult))
        callResult = ONT6xx.retrieve_lo_alarms("P1")
        print("ONT6xx.retrieve_lo_alarms result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_wavelenght("P1","W1310")
        print("ONT6xx.get_set_wavelenght result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_wavelenght("P1")
        print("ONT6xx.get_set_wavelenght result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_laser_status("P1","ON")
        print("ONT6xx.get_set_laser_status result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_laser_status("P1")
        print("ONT6xx.get_set_laser_status result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_rx_bit_rate("P1","STM16")
        print("ONT6xx.get_set_rx_bit_rate result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_tx_bit_rate("P1","STM16")
        print("ONT6xx.get_set_tx_bit_rate result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_rx_measure_channel("P1","1")
        print("ONT6xx.get_set_rx_measure_channel result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_rx_channel_mapping_size("P1","VC12")
        print("ONT6xx.get_set_rx_channel_mapping_size result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_rx_lo_measure_channel("P1","4")
        print("ONT6xx.get_set_rx_lo_measure_channel result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_alarm_insertion_type("P1","LOF")
        print("ONT6xx.get_set_alarm_insertion_type result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_alarmed_frames_number("P1","222")
        print("ONT6xx.get_set_alarmed_frames_number result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_not_alarmed_frames_number("P1","444")
        print("ONT6xx.get_set_not_alarmed_frames_number result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_alarm_activation("P1")
        print("ONT6xx.get_set_alarm_activation result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_alarm_activation("P1","OFF")
        print("ONT6xx.get_set_alarm_activation result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_alarm_insertion_mode("P1","BURST_CONT")
        print("ONT6xx.get_set_alarm_insertion_mode result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_alarm_insertion_type("P1")
        print("ONT6xx.get_set_alarm_insertion_type result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_num_alarmed_burst_frames("P1","7")
        print("ONT6xx.get_set_num_alarmed_burst_frames result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_num_not_alarmed_burst_frames("P1")
        print("ONT6xx.get_set_num_not_alarmed_burst_frames result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_num_not_alarmed_burst_frames("P1","300")
        print("ONT6xx.get_set_num_not_alarmed_burst_frames result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_error_activation("P1","ON")
        print("ONT6xx.get_set_error_activation result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_error_insertion_mode("P1","ONCE")
        print("ONT6xx.get_set_error_insertion_mode result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_error_insertion_type("P1","FAS")
        print("ONT6xx.get_set_error_insertion_type result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_error_insertion_type("P1","RSBIP")
        print("ONT6xx.get_set_error_insertion_type result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_tx_bit_rate("P1","STM16")
        print("ONT6xx.get_set_tx_bit_rate result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_tx_measure_channel("P1")
        print("ONT6xx.get_set_tx_measure_channel result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_tx_measure_channel("P1","7")
        print("ONT6xx.get_set_tx_measure_channel result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_rx_channel_mapping_size("P1","VC12")
        print("ONT6xx.get_set_rx_channel_mapping_size result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_tx_channel_mapping_size("P1","VC12")
        print("ONT6xx.get_set_tx_channel_mapping_size result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_rx_lo_measure_channel("P1","4")
        print("ONT6xx.get_set_rx_lo_measure_channel result: [{}]".format(callResult))
        callResult = ONT6xx.get_set_tx_lo_measure_channel("P1","5")
        print("ONT6xx.get_set_tx_lo_measure_channel result: [{}]".format(callResult))
        callResult = ONT6xx.retrieve_ho_alarms("P1")
        print("ONT6xx.retrieve_ho_alarms result: [{}]".format(callResult))
        callResult = ONT6xx.retrieve_lo_alarms("P1")
        print("ONT6xx.retrieve_lo_alarms result: [{}]".format(callResult))
        print("\n\n\n\n\nTESTING ONT6xx SECTION STOP **************************************")
